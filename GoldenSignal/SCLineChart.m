...
#pragma mark --myRat set
- (void)setRatArys:(NSArray *)ratArys{
    _ratArys = ratArys;
}
...
-(void)strokeChart
{
    for (int i=0; i<_yValues.count; i++) {
        ...
        for (int k=0; k< childAry.count; k++) {
...
//        pathAnimation.duration = childAry.count*0.04;
...
#pragma mark -- 每个点的圆圈
- (void)addPoint:(CGPoint)point index:(NSInteger)index isShow:(BOOL)isHollow value:(CGFloat)value andRat:(NSString *)ratValue
{
    ...
    UIImageView *ratImage = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 10, 10)];
    
    if ([ratValue isEqualToString:@"10"]) {
        [self addSubview:view];
        [view addSubview:ratImage];
        ratImage.image = [UIImage imageNamed:@"rat01.png"];
    }
    else if ([ratValue isEqualToString:@"20"]) {
        [self addSubview:view];
        [view addSubview:ratImage];
        ratImage.image = [UIImage imageNamed:@"rat02.png"];
    }
    else if ([ratValue isEqualToString:@"30"]) {
        [self addSubview:view];
        [view addSubview:ratImage];
        ratImage.image = [UIImage imageNamed:@"rat03.png"];
    }
    else if ([ratValue isEqualToString:@"40"]) {
        [self addSubview:view];
        [view addSubview:ratImage];
        ratImage.image = [UIImage imageNamed:@"rat04.png"];
    }
    else if ([ratValue isEqualToString:@"50"]) {
        [self addSubview:view];
        [view addSubview:ratImage];
        ratImage.image = [UIImage imageNamed:@"rat05.png"];
    }
//    else {
//        ratImage.backgroundColor = [UIColor blueColor];
//    }
...
- (UIView *)addImagesView:(CGPoint)point {
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(5, 5, 10, 10)];
    view.center = point;
    view.layer.borderColor = [UIColor clearColor].CGColor;
    [self addSubview:view];
...
#pragma mark -- 每个点的圆圈
- (void)addPoint2:(CGPoint)point index:(NSInteger)index isShow:(BOOL)isHollow value:(CGFloat)value
{
