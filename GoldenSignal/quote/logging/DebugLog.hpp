...
namespace bornander
{
  namespace debug
  {
    ...
    public:		// Methods
      ...
      template<typename T> void value_of(const std::string& name, const T& value, const bool outputTypeInformation);
      template<typename T> void value_of_collection(const std::string& name, const T& collection, const typename T::size_type max, const list_segment segment, const bool outputTypeInformation);
    ...
    template<typename T> void log::value_of(const std::string& name, const T& value, const bool outputTypeInformation)
    {
      write_indentation();
      *stream << name;
    ...
    template<typename T> void log::value_of_collection(const std::string& name, const T& collection, const typename T::size_type max, const list_segment segment, const bool outputTypeInformation)
    {
